...
variable "vm_instance_name" {
  description = "The name of the VM instance to replicate"
  default     = "group3vm"
}

variable "vm_instance_type" {
  description = "The type of the VM instance to replicate"
  default     = "f1-micro"
}

variable "vm_disc_type" {
  description = "The type of the VM instance to replicate"
...
variable "master_instance_name" {
  ...
  default     = "group69master-instance"
}
